...
namespace App\External\MigrateSync;

use App\Console\Commands\DatabaseMigrationSync;
...
class Schema
{
     ...
     * @param $writeIn
     */
    public function __construct($schema, DatabaseMigrationSync $writeIn)
    {
        $this->schema = $schema;
    ...
    protected function dropSchema()
    {
        ...
        $this->output()->confirm(
            "Do you want to drop <fg=white;bg=red> {$this->table} </> ?",
            true
        ) && LaravelSchema::dropIfExists($this->name);
    }
